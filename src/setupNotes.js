...
module.exports = function () {
    const msg = 'Welcome to VSCNotes. To begin, choose a location to save your notes. Click Start to continue ->'
            ...
            uriPromise
                .then(res => {
                    if (res.length > 0 && res[0].fsPath) {
                        const noteFolder = vscode.workspace.getConfiguration('vscnotes')
